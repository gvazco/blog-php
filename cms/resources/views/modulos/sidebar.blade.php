<aside class="main-sidebar sidebar-light-primary elevation-4" style="overflow-x:hidden">
  ...
  <!-- Brand Logo -->
  <a href="http://localhost/blog-php/cms/public" class="brand-link">
    <img src="http://localhost/blog-php/cms/public/vistas/img/icono.png" alt="Mevasa Logo" class="logo-image" style="max-width: 60px; margin-left: 0.5rem; margin-right: 0.6rem;"><span class="align-middle" style="color: black;">CMS | Blog</span>
  </a>
