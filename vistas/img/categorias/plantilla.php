...
<!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-68944652-5"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'UA-68944652-5');
    </script>
	...
	if(isset($_GET["pagina"])){
		...
		if($validarRuta == "categorias"){
			...
			<meta property="og:type" content="Type">
			<meta property="og:image" content="'.$blog["servidor"].$value["portada_articulo"].'">
    ...
    <!--    google_ad_client: "ca-pub-5122476742943022",-->
    ...
    <script>
      ...
      fbq('init', '199677721244098');
      fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
      src="https://www.facebook.com/tr?id=199677721244098&ev=PageView&noscript=1"
    /></noscript>
