...
<div class="container-fluid p-0 top">
	...
	<span id="top">Seguridad, Exactitud y Garantía  |  Encuentranos en: &nbsp; <i class="fa fa-phone"><span style="color:darkorange;">&nbsp;(55) 4323-4011</span></i> &nbsp;<i class="fa fa-phone"><span style="color:darkorange;">&nbsp;(55) 8185-3675</span></i> &nbsp;<i class="fa fa-envelope"> <span style="color:darkorange;">&nbsp;ventas@techosymantenimientos.com.mx</span></i></span>
		...
		<div class="row">
			...
			<div class="col-10 col-sm-11 col-md-8 pt-1 pt-lg-3 p-xl-0">
				...
				<a href="<?php echo $blog["dominio"]; ?>">
					...
					<img src="<?php echo $blog["servidor"];?><?php echo $blog["logo"]; ?>" alt="Logo de Techos y Mantenimientos" class="img-fluid logotipo">
