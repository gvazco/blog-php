...
<div class="container-fluid bg-white contenidoInicio py-2 py-md-3">
				...
				<?php foreach ($articulos as $key => $value): ?>
					...
					<div class="row">
						...
						<div class="col-12 col-lg-7 introArticulo">
							...
							<p class="my-2 my-lg-5" style="text-align: justify;"><?php echo $value["descripcion_articulo"]; ?></p>

							<a href="<?php echo $blog["dominio"].$value["ruta_categoria"]."/".$value["ruta_articulo"]; ?>" class="float-right">Leer Más</a>

							<div class="fecha mt-5 mb-1"><?php echo $value["fecha_articulo"]; ?></div>
